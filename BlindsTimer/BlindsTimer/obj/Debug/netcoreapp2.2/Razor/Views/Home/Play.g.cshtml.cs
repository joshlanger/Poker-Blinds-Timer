#pragma checksum "C:\Users\josh langer\Poker Blinds Timer\Poker-Blinds-Timer\BlindsTimer\BlindsTimer\Views\Home\Play.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "11fed0a43bc4ecc475c03d5ef4ba96ac7948ddff"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"11fed0a43bc4ecc475c03d5ef4ba96ac7948ddff", @"/Views/Home/Play.cshtml")]
...
<div id=""buttonHolder"">
    ...
    <button id=""fastForward"" onclick=""skipLevel();"">></button> ");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("source", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "11fed0a43bc4ecc475c03d5ef4ba96ac7948ddff4411", async() => {
            }
            );
...
#line 53 "C:\Users\josh langer\Poker Blinds Timer\Poker-Blinds-Timer\BlindsTimer\BlindsTimer\Views\Home\Play.cshtml"
...
#line 66 "C:\Users\josh langer\Poker Blinds Timer\Poker-Blinds-Timer\BlindsTimer\BlindsTimer\Views\Home\Play.cshtml"
                              Write(Model.BreakLength);

#line default
#line hidden
            EndContext();
            BeginContext(2378, 309, true);
            WriteLiteral(@";
                    breakTimer();
                    getBreakButtons();
                    displayBreak();
...
#line 76 "C:\Users\josh langer\Poker Blinds Timer\Poker-Blinds-Timer\BlindsTimer\BlindsTimer\Views\Home\Play.cshtml"
                              Write(Model.LevelMinutes);

#line default
#line hidden
            EndContext();
            BeginContext(2706, 1495, true);
            WriteLiteral(@";
                    levelSeconds = 0;
                    currentLevel++;
                    nextLevel++;
    ...
    function breakTimer() {
        ...
        breakTimerInterval = setInterval(function () {
            if (breakMinutes === 0 && breakSeconds === 1) {
                ...
                levelMinutes = ");
            EndContext();
            BeginContext(4202, 18, false);
#line 117 "C:\Users\josh langer\Poker Blinds Timer\Poker-Blinds-Timer\BlindsTimer\BlindsTimer\Views\Home\Play.cshtml"
                          Write(Model.LevelMinutes);

#line default
#line hidden
            EndContext();
            BeginContext(4220, 242, true);
            WriteLiteral(";\r\n                nextLevel++;\r\n                displayLevel();\r\n                displayNextLevel();\r\n                levelSeconds = 0;// making this 59 causes a skip to 58\r\n                levelTimer();\r\n                getLevelButtons();\r\n");
            EndContext();
            BeginContext(4518, 2113, true);
...
#line 188 "C:\Users\josh langer\Poker Blinds Timer\Poker-Blinds-Timer\BlindsTimer\BlindsTimer\Views\Home\Play.cshtml"
                            Write(Model.BreakFrequency);

#line default
#line hidden
            EndContext();
            BeginContext(6652, 2476, true);
            WriteLiteral(@" === 0) {
    ...
    function skipLevel() {
        if (onBreak) { //this block is screwed up somehow.  causing the break to be skipped entirely.
            pauseBreakTimer();
            breakMinutes = ");
            EndContext();
            BeginContext(9129, 17, false);
#line 252 "C:\Users\josh langer\Poker Blinds Timer\Poker-Blinds-Timer\BlindsTimer\BlindsTimer\Views\Home\Play.cshtml"
                      Write(Model.BreakLength);

#line default
#line hidden
            EndContext();
            BeginContext(9146, 223, true);
            WriteLiteral(";\r\n            breakSeconds = 0;\r\n            getLevelButtons();\r\n            currentLevel++;\r\n            \r\n            displayLevel();\r\n            displayNextLevel();\r\n            levelTimer();\r\n            \r\n        }\r\n");
            EndContext();
            BeginContext(9766, 42, true);
            WriteLiteral("       \r\n        if ((currentLevel + 1) % ");
            EndContext();
            BeginContext(9809, 20, false);
...
#line hidden
            EndContext();
            BeginContext(9829, 70, true);
            WriteLiteral(" === 0) {\r\n            pauseBreakTimer();\r\n            breakMinutes = ");
            EndContext();
            BeginContext(9900, 17, false);
...
#line hidden
            EndContext();
            BeginContext(9917, 227, true);
            WriteLiteral(";\r\n            breakSeconds = 0;\r\n            getLevelButtons();\r\n            displayLevel();\r\n            displayNextLevel();\r\n            levelTimer();\r\n        }\r\n                else {\r\n\r\n                    levelMinutes = ");
            EndContext();
            BeginContext(10145, 18, false);
#line 284 "C:\Users\josh langer\Poker Blinds Timer\Poker-Blinds-Timer\BlindsTimer\BlindsTimer\Views\Home\Play.cshtml"
                              Write(Model.LevelMinutes);
...
#line hidden
            EndContext();
            BeginContext(10464, 81, true);
            WriteLiteral(" === 0) {\r\n                    pauseTimer();\r\n                    breakMinutes = ");
            EndContext();
            BeginContext(10546, 17, false);
#line 296 "C:\Users\josh langer\Poker Blinds Timer\Poker-Blinds-Timer\BlindsTimer\BlindsTimer\Views\Home\Play.cshtml"
                              Write(Model.BreakLength);

#line default
#line hidden
            EndContext();
            BeginContext(10563, 309, true);
            WriteLiteral(@";
                    breakTimer();
                    getBreakButtons();
                    displayBreak();
